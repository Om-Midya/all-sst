  ...
  <View style={styles.container}>
    ...
    <ScrollView style={{width: '100%'}}>
      ...
      <View style={styles.coursecnt}>
        ...
        <View style={styles.course}>
          <View style={{width: '80%'}}>
            <Text style={styles.courseTitle}>Web Development 101</Text>
            <Text style={styles.courseAtt}>by Mohammad Aman</Text>
          </View>
          <View style={{height: '100%', width: '20%', alignItems: 'center'}}>
            <Text style={{fontSize: 38}}>→</Text>
          </View>
        ...
        <View style={styles.course}>
          <View style={{width: '80%'}}>
            <Text style={styles.courseTitle}>Creator Module</Text>
            <Text style={styles.courseAtt}>by Vaishnavi Reddy</Text>
          </View>
          <View style={{height: '100%', width: '20%', alignItems: 'center'}}>
            <Text style={{fontSize: 38}}>→</Text>
          </View>
